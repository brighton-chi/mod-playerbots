...
void RaidMagsLairStrategy::InitTriggers(std::vector<TriggerNode*>& triggers)
{
    triggers.push_back(new TriggerNode("magtheridon", NextAction::array(0,
        ...
        new NextAction("magtheridon cc burning abyssal", ACTION_RAID + 3),
        new NextAction("magtheridon spread ranged", ACTION_RAID + 2),
        //new NextAction("magtheridon hellfire channeler west hunter", ACTION_RAID + 2),
        //new NextAction("magtheridon hellfire channeler east hunter", ACTION_RAID + 2),
