...
class GruulTheDragonkillerTankSpotMultiplier : public Multiplier
{
public:
    GruulTheDragonkillerTankSpotMultiplier(PlayerbotAI* botAI) : Multiplier(botAI, "gruul the dragonkiller tank spot multiplier") {}
    float GetValue(Action* action) override;
};
