...
{
public:
    HighKingMaulgarIsMainTankTrigger(
        PlayerbotAI* botAI) : Trigger(botAI, "high king maulgar is main tank") {}
...
{
public:
    HighKingMaulgarIsFirstAssistTankTrigger(
        PlayerbotAI* botAI) : Trigger(botAI, "high king maulgar is first assist tank") {}
    bool IsActive() override;
};
...
{
public:
    HighKingMaulgarIsSecondAssistTankTrigger(
        PlayerbotAI* botAI) : Trigger(botAI, "high king maulgar is second assist tank") {}
    bool IsActive() override;
};
...
{
public:
    HighKingMaulgarIsMageTankTrigger(
        PlayerbotAI* botAI) : Trigger(botAI, "high king maulgar is mage tank") {}
    bool IsActive() override;
};
...
{
public:
    HighKingMaulgarIsMoonkinTankTrigger(
        PlayerbotAI* botAI) : Trigger(botAI, "high king maulgar is moonkin tank") {}
    bool IsActive() override;
};
...
{
public:
    HighKingMaulgarHealerInDangerTrigger(
        PlayerbotAI* botAI) : Trigger(botAI, "high king maulgar healers in danger") {}
    bool IsActive() override;
};
...
public:
    HighKingMaulgarWildFelstalkerSpawnedTrigger(
        PlayerbotAI* botAI) : Trigger(botAI, "high king maulgar wild felstalker spawned") {}
    bool IsActive() override;
};
...
{
public:
    HighKingMaulgarPullingOlmAndBlindeyeTrigger(
        PlayerbotAI* botAI) : Trigger(botAI, "high king maulgar pulling olm and blindeye") {}
    bool IsActive() override;
};

class HighKingMaulgarNeedToManageDpsTimerTrigger : public Trigger
{
public:
    HighKingMaulgarNeedToManageDpsTimerTrigger(
        PlayerbotAI* botAI) : Trigger(botAI, "high king maulgar need to manage dps timer") {}
    bool IsActive() override;
};
...
{
public:
    GruulTheDragonkillerBossEngagedByMainTankTrigger(
        PlayerbotAI* botAI) : Trigger(botAI, "gruul the dragonkiller boss engaged by main tank") {}
    bool IsActive() override;
};
...
{
public:
    GruulTheDragonkillerBossEngagedByRangeTrigger(
        PlayerbotAI* botAI) : Trigger(botAI, "gruul the dragonkiller boss engaged by range") {}
    bool IsActive() override;
};
