...
public:
    AlarMisdirectBossToMainTankAction(
        PlayerbotAI* botAI, std::string const name = "alar misdirect boss to main tank") : AttackAction(botAI, name) {}
    bool Execute(Event event) override;
};
...
public:
    AlarBossTanksMoveBetweenPlatformsAction(
        PlayerbotAI* botAI, std::string const name = "alar boss tanks move between platforms") : AttackAction(botAI, name) {}
    bool Execute(Event event) override;
...
public:
    AlarAddTankPickUpEmbersAction(
        PlayerbotAI* botAI, std::string const name = "alar add tank pick up embers") : AttackAction(botAI, name) {}
    bool Execute(Event event) override;
};
...
public:
    AlarJumpFromPlatformAction(
        PlayerbotAI* botAI, std::string const name = "alar jump from platform") : MovementAction(botAI, name) {}
    bool Execute(Event event) override;
};
...
public:
    AlarSwapTanksOnBossAction(
        PlayerbotAI* botAI, std::string const name = "alar swap tanks on boss") : AttackAction(botAI, name) {}
    bool Execute(Event event) override;
};
...
public:
    AlarDiveBombSpreadAndStayBackAction(
        PlayerbotAI* botAI, std::string const name = "alar dive bomb spread and stay back") : MovementAction(botAI, name) {}
    bool Execute(Event event) override;
};
...
public:
    AlarReturnToRoomCenterAction(
        PlayerbotAI* botAI, std::string const name = "alar return to room center") : MovementAction(botAI, name) {}
    bool Execute(Event event) override;
};
...
public:
    KaelthasSunstriderKiteThaladredAction(
        PlayerbotAI* botAI) : MovementAction(botAI, "kaelthas sunstrider kite thaladred") {}
    bool Execute(Event event) override;
};
...
public:
    KaelthasSunstriderMainTankPositionSanguinarAction(
        PlayerbotAI* botAI, std::string const name = "kaelthas sunstrider main tank position sanguinar") : AttackAction(botAI, name) {}
    bool Execute(Event event) override;
};
...
public:
    KaelthasSunstriderCastFearWardOnSanguinarTankAction(
        PlayerbotAI* botAI, std::string const name = "kaelthas sunstrider cast fear ward on sanguinar tank") : Action(botAI, name) {}
    bool Execute(Event event) override;
};
...
public:
    KaelthasSunstriderManageWarlockTankStrategyAction(
        PlayerbotAI* botAI, std::string const name = "kaelthas sunstrider manage warlock tank strategy") : Action(botAI, name) {}
    bool Execute(Event event) override;
};
...
public:
    KaelthasSunstriderWarlockTankPositionCapernianAction(
        PlayerbotAI* botAI, std::string const name = "kaelthas sunstrider warlock tank position capernian") : AttackAction(botAI, name) {}
    bool Execute(Event event) override;
};
...
public:
    KaelthasSunstriderMoveAwayFromCapernianAction(
        PlayerbotAI* botAI, std::string const name = "kaelthas sunstrider move away from capernian") : MovementAction(botAI, name) {}
    bool Execute(Event event) override;
};
...
public:
    KaelthasSunstriderMisdirectAdvisorsToTanksAction(
        PlayerbotAI* botAI, std::string const name = "kaelthas sunstrider misdirect advisors to tanks") : AttackAction(botAI, name) {}
    bool Execute(Event event) override;
};
...
public:
    KaelthasSunstriderManageAdvisorDpsTimerAction(
        PlayerbotAI* botAI, std::string const name = "kaelthas sunstrider manage advisor dps timer") : Action(botAI, name) {}
    bool Execute(Event event) override;
};
...
public:
    KaelthasSunstriderGroupUpLegendaryWeaponsAction(
        PlayerbotAI* botAI, std::string const name = "kaelthas sunstrider group up legendary weapons") : AttackAction(botAI, name) {}
    bool Execute(Event event) override;
};
...
public:
    KaelthasSunstriderMoveDevastationAwayAction(
        PlayerbotAI* botAI, std::string const name = "kaelthas sunstrider move devastation away") : AttackAction(botAI, name) {}
    bool Execute(Event event) override;
};
...
public:
    KaelthasSunstriderHunterTurnAwayNetherstrandLongbowAction(
        PlayerbotAI* botAI, std::string const name = "kaelthas sunstrider hunter turn away netherstrand longbow") : AttackAction(botAI, name) {}
    bool Execute(Event event) override;
};
...
public:
    KaelthasSunstriderLootLegendaryWeaponsAction(
        PlayerbotAI* botAI) : MovementAction(botAI, "kaelthas sunstrider loot legendary weapons") {}
    bool Execute(Event event) override;
...
public:
    KaelthasSunstriderUseLegendaryWeaponsAction(
        PlayerbotAI* botAI) : Action(botAI, "kaelthas sunstrider use legendary weapons") {}
    bool Execute(Event event) override;
...
public:
    KaelthasSunstriderReequipGearAction(
        PlayerbotAI* botAI) : Action(botAI, "kaelthas reequip gear") {}
    bool Execute(Event event) override;
};
...
public:
    KaelthasSunstriderAssignAdvisorDpsPriorityAction(
        PlayerbotAI* botAI, std::string const name = "kaelthas sunstrider assign advisor dps priority") : AttackAction(botAI, name) {}
    bool Execute(Event event) override;
};
...
public:
    KaelthasSunstriderMainTankPositionBossAction(
        PlayerbotAI* botAI, std::string const name = "kaelthas sunstrider main tank position boss") : AttackAction(botAI, name) {}
    bool Execute(Event event) override;
};
...
public:
    KaelthasSunstriderAvoidFlameStrikeAction(
        PlayerbotAI* botAI, std::string const name = "kaelthas sunstrider avoid flame strike") : MovementAction(botAI, name) {}
    bool Execute(Event event) override;
...
public:
    KaelthasSunstriderRoundUpPhoenixesAndFocusDownEggsAction(
        PlayerbotAI* botAI, std::string const name = "kaelthas sunstrider round up phoenixes and focus down eggs") : AttackAction(botAI, name) {}
    bool Execute(Event event) override;
};
...
public:
    KaelthasSunstriderBreakMindControlWithInfinityBladeAction(
        PlayerbotAI* botAI, std::string const name = "kaelthas sunstrider break mind control with infinity blade") : AttackAction(botAI, name) {}
    bool Execute(Event event) override;
};
...
public:
    KaelthasSunstriderBreakThroughShockBarrierAction(
        PlayerbotAI* botAI, std::string const name = "kaelthas sunstrider break through shock barrier") : AttackAction(botAI, name) {}
    bool Execute(Event event) override;
};
...
public:
    KaelthasSunstriderSpreadOutInMidairAction(
        PlayerbotAI* botAI, std::string const name = "kaelthas sunstrider spread out in midair") : MovementAction(botAI, name) {}
    bool Execute(Event event) override;
};
