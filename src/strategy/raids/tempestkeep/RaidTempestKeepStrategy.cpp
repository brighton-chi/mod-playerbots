...
void RaidTempestKeepStrategy::InitTriggers(std::vector<TriggerNode*>& triggers)
{
    ...
    triggers.push_back(new TriggerNode(
        "alar need to log info to develop boss strategy",
    ...
    triggers.push_back(new TriggerNode(
        "alar engaged by tanks in phase 1",
