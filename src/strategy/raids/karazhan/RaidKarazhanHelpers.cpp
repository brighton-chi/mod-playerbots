...
namespace KarazhanHelpers
{
    ...
    const Position KARAZHAN_NIGHTBANE_FINAL_BOSS_POSITION = Position(-11105.933f, -1878.960f, 91.473f);
    ...
    const Position KARAZHAN_NIGHTBANE_RANGED_POSITION_1 = Position(-11144.010f, -1971.745f, 91.471f);
    const Position KARAZHAN_NIGHTBANE_RANGED_POSITION_2 = Position(-11143.000f, -1955.644f, 91.473f);
