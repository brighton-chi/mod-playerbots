...
void RaidKarazhanStrategy::InitTriggers(std::vector<TriggerNode*>& triggers)
{
    ...
    triggers.push_back(new TriggerNode(
        "big bad wolf boss engaged by main tank",
    ...
    triggers.push_back(new TriggerNode(
        "the curator boss engaged by ranged",
    ...
    triggers.push_back(new TriggerNode(
        "shade of aran flame wreath is casting",
    ...
    triggers.push_back(new TriggerNode(
        "shade of aran boss engaged by ranged",
    ...
    triggers.push_back(new TriggerNode(
        "netherspite need to manage timers",
    ...
    triggers.push_back(new TriggerNode(
        "nightbane ranged prepare for charred earth",
