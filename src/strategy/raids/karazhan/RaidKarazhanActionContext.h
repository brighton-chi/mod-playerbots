...
public:
    RaidKarazhanActionContext()
    {
        ...
        creators["shade of aran ranged maintain distance"] = &RaidKarazhanActionContext::shade_of_aran_ranged_maintain_distance;
...
private:
    ...
    static Action* shade_of_aran_ranged_maintain_distance(PlayerbotAI* botAI) { return new ShadeOfAranRangedMaintainDistanceAction(botAI); }
