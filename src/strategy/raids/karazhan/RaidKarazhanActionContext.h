...
public:
    RaidKarazhanActionContext()
    {
        ...
        creators["karazhan shade of aran flame wreath stop pet"] = &RaidKarazhanActionContext::karazhan_shade_of_aran_flame_wreath_stop_pet;
...
private:
    ...
    static Action* karazhan_wizard_of_oz_fear_roar(PlayerbotAI* botAI) { return new KarazhanWizardOfOzFearRoarAction(botAI); }
    ...
    static Action* karazhan_shade_of_aran_arcane_explosion(PlayerbotAI* botAI) { return new KarazhanShadeOfAranArcaneExplosionAction(botAI); }
    ...
    static Action* karazhan_shade_of_aran_flame_wreath_stop_pet(PlayerbotAI* botAI) { return new KarazhanShadeOfAranFlameWreathStopPetAction(botAI); }
    static Action* karazhan_shade_of_aran_mark_target(PlayerbotAI* botAI) { return new KarazhanShadeOfAranMarkTargetAction(botAI); }
