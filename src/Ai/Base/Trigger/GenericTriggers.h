...
{
public:
    RandomBotUpdateTrigger(PlayerbotAI* botAI)
        : RandomTrigger(botAI, "random bot update", 30 * IN_MILLISECONDS) {}
...
{
public:
    NewPlayerNearbyTrigger(PlayerbotAI* botAI)
        : Trigger(botAI, "new player nearby", 10 * IN_MILLISECONDS) {}
