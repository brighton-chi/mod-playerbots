...
public:
    RaidHyjalSummitTriggerContext()
    {
        ...
        // Rage Winterchill
        creators["rage winterchill pulling boss"] = &RaidHyjalSummitTriggerContext::rage_winterchill_pulling_boss;
        ...
        // Kaz'rogal
        creators["kaz'rogal pulling boss"] = &RaidHyjalSummitTriggerContext::kazrogal_pulling_boss;
        ...
        creators["kaz'rogal bot is low on mana"] = &RaidHyjalSummitTriggerContext::kazrogal_bot_is_low_on_mana;
        ...
        // Azgalor
        creators["azgalor pulling boss"] = &RaidHyjalSummitTriggerContext::azgalor_pulling_boss;
        ...
        creators["azgalor bot is doomed"] = &RaidHyjalSummitTriggerContext::azgalor_bot_is_doomed;
        ...
        // Archimonde
        creators["archimonde pulling boss"] = &RaidHyjalSummitTriggerContext::archimonde_pulling_boss;

        creators["archimonde boss engaged by main tank"] =
            &RaidHyjalSummitTriggerContext::archimonde_boss_engaged_by_main_tank;

        creators["archimonde boss casts fear"] = &RaidHyjalSummitTriggerContext::archimonde_boss_casts_fear;

        creators["archimonde boss casts air burst"] = &RaidHyjalSummitTriggerContext::archimonde_boss_casts_air_burst;
...
private:
    ...
    static Trigger* rage_winterchill_boss_casts_death_and_decay(PlayerbotAI* botAI)
    {
        return new RageWinterchillBossCastsDeathAndDecayTrigger(botAI);
    }

    static Trigger* rage_winterchill_bot_is_standing_in_death_and_decay(PlayerbotAI* botAI)
    {
        return new RageWinterchillBotIsStandingInDeathAndDecayTrigger(botAI);
    }
    ...
    // Kaz'rogal
    static Trigger* kazrogal_pulling_boss(PlayerbotAI* botAI) { return new KazrogalPullingBossTrigger(botAI); }
    ...
    static Trigger* kazrogal_bot_is_low_on_mana(PlayerbotAI* botAI) { return new KazrogalBotIsLowOnManaTrigger(botAI); }
    ...
    // Azgalor
    static Trigger* azgalor_pulling_boss(PlayerbotAI* botAI) { return new AzgalorPullingBossTrigger(botAI); }
    ...
    static Trigger* azgalor_boss_casts_rain_of_fire_on_ranged(PlayerbotAI* botAI)
    {
        return new AzgalorBossCastsRainOfFireOnRangedTrigger(botAI);
    }
    ...
    static Trigger* azgalor_bot_is_doomed(PlayerbotAI* botAI) { return new AzgalorBotIsDoomedTrigger(botAI); }
    ...
    static Trigger* azgalor_doomguards_continue_to_spawn(PlayerbotAI* botAI)
    {
        return new AzgalorDoomguardsContinueToSpawnTrigger(botAI);
    }

    // Archimonde
    static Trigger* archimonde_pulling_boss(PlayerbotAI* botAI) { return new ArchimondePullingBossTrigger(botAI); }
    ...
    static Trigger* archimonde_boss_casts_fear(PlayerbotAI* botAI) { return new ArchimondeBossCastsFearTrigger(botAI); }
