...
public:
    ...
    {
        // General
        creators["hyjal summit erase trackers"] = &RaidHyjalSummitActionContext::hyjal_summit_erase_trackers;
        ...
        creators["anetheron assign dps priority"] = &RaidHyjalSummitActionContext::anetheron_assign_dps_priority;

        // Kaz'rogal
        creators["kaz'rogal misdirect boss to main tank"] =
            &RaidHyjalSummitActionContext::kazrogal_misdirect_boss_to_main_tank;

        creators["kaz'rogal main tank position boss"] = &RaidHyjalSummitActionContext::kazrogal_main_tank_position_boss;
        ...
        creators["kaz'rogal spread ranged in arc"] = &RaidHyjalSummitActionContext::kazrogal_spread_ranged_in_arc;
        ...
        creators["azgalor main tank position boss"] = &RaidHyjalSummitActionContext::azgalor_main_tank_position_boss;

        creators["azgalor wait at safe position"] = &RaidHyjalSummitActionContext::azgalor_wait_at_safe_position;

        creators["azgalor disperse ranged"] = &RaidHyjalSummitActionContext::azgalor_disperse_ranged;

        creators["azgalor melee get out of fire"] = &RaidHyjalSummitActionContext::azgalor_melee_get_out_of_fire;
        ...
        creators["azgalor assign dps priority"] = &RaidHyjalSummitActionContext::azgalor_assign_dps_priority;
        ...
        creators["archimonde avoid doomfire"] = &RaidHyjalSummitActionContext::archimonde_avoid_doomfire;

        creators["archimonde remove doomfire dot"] = &RaidHyjalSummitActionContext::archimonde_remove_doomfire_dot;
    }

private:
    // General
    static Action* hyjal_summit_erase_trackers(PlayerbotAI* botAI) { return new HyjalSummitEraseTrackersAction(botAI); }
    ...
    static Action* rage_winterchill_move_away_from_death_and_decay(PlayerbotAI* botAI)
    {
        return new RageWinterchillMoveAwayFromDeathAndDecayAction(botAI);
    }
    ...
    static Action* azgalor_disperse_ranged(PlayerbotAI* botAI) { return new AzgalorDisperseRangedAction(botAI); }

    static Action* azgalor_melee_get_out_of_fire(PlayerbotAI* botAI)
    {
    ...
    static Action* azgalor_assign_dps_priority(PlayerbotAI* botAI) { return new AzgalorAssignDpsPriorityAction(botAI); }
    ...
    static Action* archimonde_avoid_doomfire(PlayerbotAI* botAI) { return new ArchimondeAvoidDoomfireAction(botAI); }
