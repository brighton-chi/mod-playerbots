...
{
public:
    HyjalSummitBotIsNotInCombatTrigger(PlayerbotAI* botAI) : Trigger(botAI, "hyjal summit bot is not in combat") {}
...
{
public:
    RageWinterchillPullingBossTrigger(PlayerbotAI* botAI) : Trigger(botAI, "rage winterchill pulling boss") {}
    bool IsActive() override;
};
...
{
public:
    RageWinterchillBossCastsDeathAndDecayTrigger(PlayerbotAI* botAI)
        : Trigger(botAI, "rage winterchill boss casts death and decay")
    {
    }
    bool IsActive() override;
};
...
{
public:
    RageWinterchillBotIsStandingInDeathAndDecayTrigger(PlayerbotAI* botAI)
        : Trigger(botAI, "rage winterchill bot is standing in death and decay")
    {
    }
    bool IsActive() override;
};
...
{
public:
    AnetheronPullingBossOrInfernalTrigger(PlayerbotAI* botAI) : Trigger(botAI, "anetheron pulling boss or infernal") {}
    bool IsActive() override;
};
...
{
public:
    AnetheronBossEngagedByMainTankTrigger(PlayerbotAI* botAI) : Trigger(botAI, "anetheron boss engaged by main tank") {}
    bool IsActive() override;
};
...
{
public:
    AnetheronBossCastsCarrionSwarmTrigger(PlayerbotAI* botAI) : Trigger(botAI, "anetheron boss casts carrion swarm") {}
    bool IsActive() override;
};
...
{
public:
    KazrogalPullingBossTrigger(PlayerbotAI* botAI) : Trigger(botAI, "kaz'rogal pulling boss") {}
    bool IsActive() override;
};
...
{
public:
    KazrogalBossEngagedByMainTankTrigger(PlayerbotAI* botAI) : Trigger(botAI, "kaz'rogal boss engaged by main tank") {}
    bool IsActive() override;
};
...
{
public:
    KazrogalBotIsLowOnManaTrigger(PlayerbotAI* botAI) : Trigger(botAI, "kaz'rogal bot is low on mana") {}
    bool IsActive() override;
};
...
{
public:
    KazrogalMarkDealsShadowDamageTrigger(PlayerbotAI* botAI) : Trigger(botAI, "kaz'rogal mark deals shadow damage") {}
    bool IsActive() override;
};
...
{
public:
    AzgalorPullingBossTrigger(PlayerbotAI* botAI) : Trigger(botAI, "azgalor pulling boss") {}
    bool IsActive() override;
};
...
{
public:
    AzgalorBossEngagedByMainTankTrigger(PlayerbotAI* botAI) : Trigger(botAI, "azgalor boss engaged by main tank") {}
    bool IsActive() override;
};
...
{
public:
    AzgalorMainTankIsPositioningBossTrigger(PlayerbotAI* botAI)
        : Trigger(botAI, "azgalor main tank is positioning boss")
    {
    }
    bool IsActive() override;
};
...
{
public:
    AzgalorBossCastsRainOfFireOnRangedTrigger(PlayerbotAI* botAI)
        : Trigger(botAI, "azgalor boss casts rain of fire on ranged")
    {
    }
    bool IsActive() override;
};
...
{
public:
    AzgalorDoomguardsContinueToSpawnTrigger(PlayerbotAI* botAI) : Trigger(botAI, "azgalor doomguards continue to spawn")
    {
    }
    bool IsActive() override;
};
...
{
public:
    ArchimondePullingBossTrigger(PlayerbotAI* botAI) : Trigger(botAI, "archimonde pulling boss") {}
    bool IsActive() override;
};
...
{
public:
    ArchimondeBossEngagedByMainTankTrigger(PlayerbotAI* botAI) : Trigger(botAI, "archimonde boss engaged by main tank")
    {
    }
    bool IsActive() override;
};
...
{
public:
    ArchimondeBossCastsFearTrigger(PlayerbotAI* botAI) : Trigger(botAI, "archimonde boss casts fear") {}
    bool IsActive() override;
};
...
{
public:
    ArchimondeBossCastsAirBurstTrigger(PlayerbotAI* botAI) : Trigger(botAI, "archimonde boss casts air burst") {}
    bool IsActive() override;
};
...
{
public:
    ArchimondeBossSummonedDoomfireTrigger(PlayerbotAI* botAI) : Trigger(botAI, "archimonde boss summoned doomfire") {}
    bool IsActive() override;
};
...
{
public:
    ArchimondeBotStoodInDoomfireTrigger(PlayerbotAI* botAI) : Trigger(botAI, "archimonde bot stood in doomfire") {}
    bool IsActive() override;
};
