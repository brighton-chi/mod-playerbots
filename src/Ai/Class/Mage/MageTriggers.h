...
{
public:
    ArcaneIntellectTrigger(PlayerbotAI* botAI)
        : BuffTrigger(botAI, "arcane intellect", 8 * IN_MILLISECONDS) {}
...
{
public:
    MoltenArmorTrigger(PlayerbotAI* botAI)
        : BuffTrigger(botAI, "molten armor", 10 * IN_MILLISECONDS) {}
    bool IsActive() override;
};
