...
#ifndef PLAYERBOTS_WARRIORACTIONS_H
#define PLAYERBOTS_WARRIORACTIONS_H
...
class CastVigilanceAction : public CastSpellAction
{
public:
    CastVigilanceAction(PlayerbotAI* botAI) : CastSpellAction(botAI, "vigilance") {}
