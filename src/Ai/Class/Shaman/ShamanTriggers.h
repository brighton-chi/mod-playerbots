...
#ifndef PLAYERBOTS_SHAMANTRIGGERS_H
#define PLAYERBOTS_SHAMANTRIGGERS_H
...
{
public:
    WaterBreathingTrigger(PlayerbotAI* botAI)
        : BuffTrigger(botAI, "water breathing", 10 * IN_MILLISECONDS) {}
