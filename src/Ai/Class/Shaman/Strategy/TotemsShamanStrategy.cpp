...
void StrengthOfEarthTotemStrategy::InitTriggers(std::vector<TriggerNode*>& triggers)
{
    ...
    triggers.push_back(new TriggerNode("set strength of earth totem", {
        NextAction("set strength of earth totem", 60.0f) }));
    triggers.push_back(new TriggerNode("no earth totem", {
        NextAction("strength of earth totem", 55.0f) }));
}
...
{
    GenericShamanStrategy::InitTriggers(triggers);
    triggers.push_back(new TriggerNode("set stoneskin totem", {
        NextAction("set stoneskin totem", 60.0f) }));
    triggers.push_back(new TriggerNode("no earth totem", {
        NextAction("stoneskin totem", 55.0f) }));
}
...
{
    GenericShamanStrategy::InitTriggers(triggers);
    triggers.push_back(new TriggerNode("set tremor totem", {
        NextAction("set tremor totem", 60.0f) }));
    triggers.push_back(new TriggerNode("no earth totem", {
        NextAction("tremor totem", 55.0f) }));
}
...
{
    GenericShamanStrategy::InitTriggers(triggers);
    triggers.push_back(new TriggerNode("set earthbind totem", {
        NextAction("set earthbind totem", 60.0f) }));
    triggers.push_back(new TriggerNode("no earth totem", {
        NextAction("earthbind totem", 55.0f) }));
}
...
{
    GenericShamanStrategy::InitTriggers(triggers);
    triggers.push_back(new TriggerNode("set searing totem", {
        NextAction("set searing totem", 60.0f) }));
    triggers.push_back(new TriggerNode("no fire totem", {
        NextAction("searing totem", 55.0f) }));
}
...
{
    GenericShamanStrategy::InitTriggers(triggers);
    triggers.push_back(new TriggerNode("set magma totem", {
        NextAction("set magma totem", 60.0f) }));
    triggers.push_back(new TriggerNode("no fire totem", {
        NextAction("magma totem", 55.0f) }));
}
...
{
    GenericShamanStrategy::InitTriggers(triggers);
    triggers.push_back(new TriggerNode("set flametongue totem", {
        NextAction("set flametongue totem", 60.0f) }));
    triggers.push_back(new TriggerNode("no fire totem", {
        NextAction("flametongue totem", 55.0f) }));
}
...
void TotemOfWrathStrategy::InitTriggers(std::vector<TriggerNode*>& triggers)
{
    ...
    {
        triggers.push_back(new TriggerNode("set totem of wrath", {
            NextAction("set totem of wrath", 60.0f) }));
    }
    ...
    triggers.push_back(new TriggerNode("no fire totem", {
        NextAction("totem of wrath", 55.0f) }));
}
...
{
    GenericShamanStrategy::InitTriggers(triggers);
    triggers.push_back(new TriggerNode("set frost resistance totem", {
        NextAction("set frost resistance totem", 60.0f) }));
    triggers.push_back(new TriggerNode("no fire totem", {
        NextAction("frost resistance totem", 55.0f) }));
}
...
{
    GenericShamanStrategy::InitTriggers(triggers);
    triggers.push_back(new TriggerNode("set healing stream totem", {
        NextAction("set healing stream totem", 60.0f) }));
    triggers.push_back(new TriggerNode("no water totem", {
        NextAction("healing stream totem", 55.0f) }));
}
...
{
    GenericShamanStrategy::InitTriggers(triggers);
    triggers.push_back(new TriggerNode("set mana spring totem", {
        NextAction("set mana spring totem", 60.0f) }));
    triggers.push_back(new TriggerNode("no water totem", {
        NextAction("mana spring totem", 55.0f) }));
}
...
void CleansingTotemStrategy::InitTriggers(std::vector<TriggerNode*>& triggers)
{
    ...
    {
        triggers.push_back(new TriggerNode("set cleansing totem", {
            NextAction("set cleansing totem", 60.0f) }));
    }
    ...
    triggers.push_back(new TriggerNode("no water totem", {
        NextAction("cleansing totem", 55.0f) }));
}
...
{
    GenericShamanStrategy::InitTriggers(triggers);
    triggers.push_back(new TriggerNode("set fire resistance totem", {
        NextAction("set fire resistance totem", 60.0f) }));
    triggers.push_back(new TriggerNode("no fire totem", {
        NextAction("fire resistance totem", 55.0f) }));
}
...
void WrathOfAirTotemStrategy::InitTriggers(std::vector<TriggerNode*>& triggers)
{
    ...
    {
        triggers.push_back(new TriggerNode("set wrath of air totem", {
            NextAction("set wrath of air totem", 60.0f) }));
    }
    else if (bot->HasSpell(8177))
    {
        triggers.push_back(new TriggerNode("set grounding totem", {
            NextAction("set grounding totem", 60.0f) }));
    }
    triggers.push_back( new TriggerNode("no air totem", {
        NextAction("wrath of air totem", 55.0f) }));
}
...
void WindfuryTotemStrategy::InitTriggers(std::vector<TriggerNode*>& triggers)
{
    ...
    {
        triggers.push_back(new TriggerNode("set windfury totem", {
            NextAction("set windfury totem", 60.0f) }));
    }
    else if (bot->HasSpell(8177))
    {
        triggers.push_back(new TriggerNode("set grounding totem", {
    ...
    triggers.push_back(new TriggerNode("no air totem", {
        NextAction("windfury totem", 55.0f) }));
}
...
{
    GenericShamanStrategy::InitTriggers(triggers);
    triggers.push_back(new TriggerNode("set nature resistance totem", {
        NextAction("set nature resistance totem", 60.0f) }));
    triggers.push_back(new TriggerNode("no air totem", {
        NextAction("nature resistance totem", 55.0f) }));
}
...
void GroundingTotemStrategy::InitTriggers(std::vector<TriggerNode*>& triggers)
{
    ...
    triggers.push_back(new TriggerNode("set grounding totem", {
        NextAction("set grounding totem", 60.0f) }));
    triggers.push_back(new TriggerNode("no air totem", {
        NextAction("grounding totem", 55.0f) }));
}
